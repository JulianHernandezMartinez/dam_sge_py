...
n = input("You're in the Lost Forest. Go L(left)  or R (right)? ")
while n == "R":
...
mysum= 0
for i in range(7, 10): #suma del 7 al 9 inclusives
    mysum+= i
print(mysum)
# 24
mysum= 0
for i in range(5, 11, 2): # suma de impares del 5 al 9
    mysum+= i
print(mysum)
#21
